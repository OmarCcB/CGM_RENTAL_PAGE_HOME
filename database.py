...
def init_admin_tables(conn=None):
    ...
    CREATE TABLE IF NOT EXISTS popups (
        ...
        imagen_altura       INTEGER DEFAULT 280,
        popup_ancho         INTEGER DEFAULT 520,
        ...
        overlay_alineacion  TEXT DEFAULT 'izquierda',
        popup_radio         INTEGER DEFAULT 14,
        popup_bg            TEXT DEFAULT '#111111',
        popup_posicion      TEXT DEFAULT 'centro',
        popup_sombra        TEXT DEFAULT 'lg',
        popup_borde_ancho   INTEGER DEFAULT 0,
        popup_borde_color   TEXT DEFAULT '#ffffff',
        backdrop_color      TEXT DEFAULT 'rgba(0,0,0,0.65)',
        backdrop_blur       INTEGER DEFAULT 0,
        backdrop_cerrar     INTEGER DEFAULT 1,
        imagen_modo         TEXT DEFAULT 'ratio',
        cerrar_estilo       TEXT DEFAULT 'dentro',
        cerrar_color        TEXT DEFAULT '#ffffff',
        cerrar_delay_ms     INTEGER DEFAULT 0,
        contenido_activo    INTEGER DEFAULT 0,
        contenido_titulo    TEXT DEFAULT '',
        contenido_descripcion TEXT DEFAULT '',
        contenido_bg        TEXT DEFAULT '#ffffff',
        contenido_color_texto TEXT DEFAULT '#222222',
        contenido_alineacion TEXT DEFAULT 'izquierda',
        boton_radio         INTEGER DEFAULT 6,
        boton_ancho_completo INTEGER DEFAULT 0,
        prioridad           INTEGER DEFAULT 0,
        disparador          TEXT DEFAULT 'tiempo',
        scroll_pct          INTEGER DEFAULT 50,
    ...
    for sql in [
        ...
        "ALTER TABLE popups ADD COLUMN imagen_altura INTEGER DEFAULT 280",
        "ALTER TABLE popups ADD COLUMN popup_ancho INTEGER DEFAULT 520",
        ...
        "ALTER TABLE popups ADD COLUMN popup_posicion TEXT DEFAULT 'centro'",
        "ALTER TABLE popups ADD COLUMN popup_sombra TEXT DEFAULT 'lg'",
        "ALTER TABLE popups ADD COLUMN popup_borde_ancho INTEGER DEFAULT 0",
        "ALTER TABLE popups ADD COLUMN popup_borde_color TEXT DEFAULT '#ffffff'",
        "ALTER TABLE popups ADD COLUMN backdrop_color TEXT DEFAULT 'rgba(0,0,0,0.65)'",
        "ALTER TABLE popups ADD COLUMN backdrop_blur INTEGER DEFAULT 0",
        "ALTER TABLE popups ADD COLUMN backdrop_cerrar INTEGER DEFAULT 1",
        "ALTER TABLE popups ADD COLUMN imagen_modo TEXT DEFAULT 'ratio'",
        "ALTER TABLE popups ADD COLUMN cerrar_estilo TEXT DEFAULT 'dentro'",
        "ALTER TABLE popups ADD COLUMN cerrar_color TEXT DEFAULT '#ffffff'",
        "ALTER TABLE popups ADD COLUMN cerrar_delay_ms INTEGER DEFAULT 0",
        "ALTER TABLE popups ADD COLUMN overlay_alineacion TEXT DEFAULT 'izquierda'",
        "ALTER TABLE popups ADD COLUMN contenido_alineacion TEXT DEFAULT 'izquierda'",
        "ALTER TABLE popups ADD COLUMN boton_radio INTEGER DEFAULT 6",
        "ALTER TABLE popups ADD COLUMN boton_ancho_completo INTEGER DEFAULT 0",
        "ALTER TABLE popups ADD COLUMN prioridad INTEGER DEFAULT 0",
        "ALTER TABLE popups ADD COLUMN disparador TEXT DEFAULT 'tiempo'",
        "ALTER TABLE popups ADD COLUMN scroll_pct INTEGER DEFAULT 50",
        "ALTER TABLE popups ADD COLUMN mostrar_en TEXT DEFAULT 'todas'",
        "ALTER TABLE popups ADD COLUMN rutas TEXT DEFAULT ''",
    ]:
        try:
            conn.execute(sql)
        except Exception:
